...
static inline size_t crypto_chacha20_ref_block_size(void)
{
	return CRYPTO_CHACHA20_REF_BLOCKSIZE;
}

static inline size_t crypto_chacha20_ref_key_size(void)
{
	return CRYPTO_CHACHA20_REF_KEYSIZE;
}

static inline size_t crypto_chacha20_ref_nonce_size(void)
{
...
static inline size_t crypto_chacha20_ietf_block_size(void)
{
	return CRYPTO_CHACHA20_IETF_BLOCKSIZE;
}

static inline size_t crypto_chacha20_ietf_key_size(void)
{
	return CRYPTO_CHACHA20_IETF_KEYSIZE;
}

static inline size_t crypto_chacha20_ietf_nonce_size(void)
{
...
static inline size_t crypto_poly1305_block_size(void)
{
	return CRYPTO_POLY1305_BLOCKSIZE;
}

static inline size_t crypto_poly1305_key_size(void)
{
